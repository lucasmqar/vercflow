...
export function ThemeToggleFloating() {
    ...
    return (
        <motion.div
            ...
            className="p-1.5 rounded-[20px] bg-background/25 backdrop-blur-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] glass-hub flex items-center gap-1"
        >
            <button
